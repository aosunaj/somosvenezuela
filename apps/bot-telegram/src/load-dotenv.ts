...
// local). Mismo patron que packages/db/src/loadDotenv.ts: en produccion (Railway/
// Render) y en CI las variables vienen del entorno real y no hay .env -> no-op.
// NUNCA imprime valores.

const __dirname = dirname(fileURLToPath(import.meta.url));
/** .env en la raiz del repo (este archivo vive en apps/bot-telegram/src). */
